                            ...
                            <div class="container">
                                <div class="card border-light-subtle shadow-sm">
                                    <div class="col g-0 d-flex flex-column align-items-center justify-content-center">
                                        ...
                                        <div class="text_area">
                                            <textarea name="title" id="" cols="50" rows="1" class="texta1 fs-1 border-0 mb-0" placeholder="Untitled:Part 1">{{ $chapter->title }}</textarea>
                                            <hr class="m-0">
                                            <textarea name="content" id="" cols="100" rows="20" class="texta2 fs-5 border-0" placeholder="Please start your story here....">{{ $chapter->content }}</textarea>
                                        </div>
                                    </div>
